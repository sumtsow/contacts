...
return [
    ...
    */
    ...
    'accepted_if' => ':attribute повинні бути прийняті, коли :other дорівнює :value.',
    ...
    'date_equals' => ':attribute дає бути датою, рівною :date.',
    'date_format' => ':attribute не відповідає формату :format.',
    'declined' => ':attribute має бути відхилено.',
    'declined_if' => ':attribute має бути відхилено коли :other дорівнює :value.',
    ...
    'ends_with' => ':attribute має завершуватися одним з варіантів: :values.',
    'enum' => 'Виділений :attribute є недійсним.',
    ...
    'mac_address' => ':attribute має бути вірною MAC адресою.',
    'max' => [
    ...
    'multiple_of' => ':attribute має бути комбінацією з :value.',
    'not_in' => 'Виділений :attribute є недійсним.',
    'not_regex' => ':attribute має невірний формат.',
    'numeric' => ':attribute має бути числом.',
    'password' => 'Невірний пароль.',
    'present' => 'Поле атрибута :attribute має бути присутнім.',
    'prohibited' => 'Поле атрибута :attribute заборонене.',
    'prohibited_if' => 'Поле атрибута :attribute заборонене при :other дорівнює :value.',
    'prohibited_unless' => 'Поле атрибута :attribute заборонене, якщо :other немає серед :values.',
    'prohibits' => 'Поле атрибута :attribute забороняє присутність :other.',
    'regex' => ':attribute має невірний формат.',
    'required' => ":attribute поле є обов'язковим.",
    'required_array_keys' => 'Поле атрибута :attribute має містити співпадіння з: :values.',
    ...
    'starts_with' => ':attribute має починатися з одного з варіантів: :values.',
